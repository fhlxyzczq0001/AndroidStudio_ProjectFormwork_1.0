package com.ddtkj.projectformwork.business.Base.Application.release;
...
public class Business_Application implements Business_Application_Interface {
     ...
     * @return
     */
    public void initBusiness_Application(Application application, Common_Application mCommonApplication){
        mApplication=application;
        Business_Application.mCommonApplication=mCommonApplication;
